...
const Slideshow = () => {
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img src="https://elabd.blob.core.windows.net/elabdcontainer/2f618df1-7e93-4a6d-a977-50f6f4c4cfd2-638011778413534846.jpg" class="d-block w-100" alt="..."/>
    </div>
     
    <div class="carousel-item">
      <img src="https://elabd.blob.core.windows.net/elabdcontainer/2e4e3994-f410-41c8-ae53-0dcc0a25445c-638016983157450045.jpg" class="d-block w-100" alt="..."/>
    </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    //       <img className="d-block w-100" src="https://elabd.blob.core.windows.net/elabdcontainer/6a6d9993-4fc7-45fa-bea9-9fed21f50027-638016983256839513.jpg" alt="Seco/nd slide" />
    //     </div>
