...
const Cards = (props) => {
    ...
    return (
        <div className="card h-100 w-100 " style={{minWidth: '150px',height: '16rem' }}  >
...
<div  class="border border-primary d-flex justify-content-center" style={{ width: '18rem', height: '23rem' }}>
    <img  style={{ height: 'auto', maxHeight: '100%' }} className="card-img-top" src={`${props.img || defult.img}`} alt="Card image cap" />
</div>

<div class="card-body">
    <h5 class="card-title"><Link to="/Singleproduct">     {props.name || defult.name}</Link></h5>
    <p class="card-text"><strong>{props.prise || defult.prise} EGP </strong>
    </p>
</div>
