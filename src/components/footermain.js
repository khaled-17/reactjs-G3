        ...
        <div className="container pt-5">
            <div className="row">
                ...
                <div className="col-md col-sm-12">
                    ...
                    <svg style={{ margin: "10px", color: "#7D3C2E" }} xmlns="http://www.w3.org/2000/svg" width="30" fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
                    ...
                    <svg style={{ margin: "10px", color: "#7D3C2E" }} xmlns="http://www.w3.org/2000/svg" width="30" fill="currentColor" className="bi bi-youtube" viewBox="0 0 16 16">
